...
impl Session {
    ...
    pub fn pending_interests(&self) -> HashSet<Cid> {
        self.interests
            .difference(&self.received_blocks)
            .cloned()
            .collect()
    }
    ...
    pub fn statistics(&self) -> SessionStats {
        ...
        if stats.blocks_received > 0 {
            ...
            stats.average_response_time_ms =
                stats.duration.as_millis() as f64 / stats.blocks_received as f64;
        }
...
impl SessionManager {
    ...
    pub fn get_statistics(&self) -> SessionManagerStats {
        ...
        if stats.total_blocks_requested > 0 {
            stats.success_rate =
                (stats.total_blocks_received as f64 / stats.total_blocks_requested as f64) * 100.0;
        }
